                    ...
                    for (var i=0;i<json.class_no.length;i++){
                        ...
                        if (json.collection[i]==='1'){
                            $('#collection_ul').append(
                                ...
                                '                                        <img width="200" height="113" src="'+json.img_address[i]+'" />\n' +
                                '                                    </a>\n' +
                                '                                </div>\n' +
                                ...
                                '                                        <!-- 收藏和删除 -->\n' +
                                '                                        <div class="share-box">\n' +
                                '                                            <a href="javascript:void(0);" onclick="collection(this,2)" title="收藏" ><i class="fa fa-star"></i></a>\n' +
                                ...
                                '                                        <span class="i-mid span-common">用时26小时52分</span>\n' +
                                '                                        <span class="i-right span-common">学习至2-1 自然语言处理开发环境介绍</span>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="catog-points">\n' +
                                '                                        <span class="i-left span-common"><a href="">笔记 '+note+'</a></span>\n' +
                                '                                        <span class="i-right span-common"><a href="">问答 '+ask+'</a></span>\n' +
                                '                                        <button type="button" class="btn btn-outline-primary" style="right: 32px;position: absolute;">继续学习</button>\n' +
                                '                                    </div>\n' +
                                '                                </div>\n' +
                                '                            </li>'
                            );
                            ...
                            $('#learning_ul').append(
                                ...
                                '                                        <!-- 收藏和删除 -->\n' +
                                '                                        <div class="share-box">\n' +
                                '                                            <a href="javascript:void(0);" onclick="collection(this,1)" title="收藏" ><i class="fa fa-star-o"></i></a>\n' +
                                '                                            <a href="javascript:void(0);" onclick="delete_class_no('+json.class_no[i]+')" data-toggle="modal"  data-target="#Delete_Class"  title="删除" ><i class="fa fa-trash-o"></i></a>\n' +
                                '                                        </div>\n' +
                                '                                    </h3>\n' +
                                '                                    <div class="study-points">\n' +
                ...
                <div style="margin-bottom: 12px;">
                    <div style="width: 88%;float: left;">
                        <ul class="title-list nav nav-pills " >
                            <li class="nav-item"><a class="nav-link active" data-toggle="pill" href="#learning" >学习中</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top: 40%">
            ...
            <div class="modal-body">
                ...
                <button id="Delete_Class_sure_button" type="button" class="btn btn-primary" onclick="" style="float: right">确定
                </button>
            </div>
        </div>
    </div>
